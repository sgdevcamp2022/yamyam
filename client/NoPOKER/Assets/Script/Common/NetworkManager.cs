...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    void Awake() => Screen.SetResolution(960, 540, false); // PC에서 빌드를 하기 위해 가로 960, 세로 540으로 했다?

    void Update() => StatusText.text = PhotonNetwork.NetworkClientState.ToString(); //상태 텍스트에 어떤 상태로 연결되어있는지 표시 ( 연결되어있는지, 방에있는지, 로비에있는지)
